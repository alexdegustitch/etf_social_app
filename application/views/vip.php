                    ...
                    <ul class='nav navbar-nav'>
                        <li class='nav-item dropdown'>
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="<?php echo site_url('VipController/izmeniProfil') ?>"> Izmeni profil </a>
                                <a class="dropdown-item" href="<?php echo site_url('VipController/izmeniOdgovore') ?>"> Izmeni odgovore </a>
                                <a class="dropdown-item" href="<?php echo site_url('VipController/obrisi') ?>"> Obrisi </a>   
                                <a class="dropdown-item" href="<?php echo site_url('VipController/izlogujSe') ?>"> Izloguj se </a>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <div class="container" style="background-image: url('http://localhost/social/images/50.jpg');">
            ...
            <div class = "row">
                <div class = "col-sm-12 col-md-4 col-lg-4">
                    ...
                    <p class = "par" style = "border: 1px dotted; ">
                        ...
                        foreach ($zapraceni as $zapracen) {
                            echo "<a href='" . site_url('VipController/posetiProfil/') . $zapracen . "'> @" . $zapracen . " </a> <br/>";
                        }
                        ?>
                    </p>
                </div>
                <div class="col-sm-12 col-md-4 col-lg-4">
                    ...
                    <form name="formaSlika" action="<?php echo site_url('VipController/promeniSliku') ?>" method="get">
                        <center>
                ...
                <div class="col-sm-12 col-md-4 col-lg-4" style="padding: 20px; padding-top: 100px; ">
                    <form name="podaci" action="<?php echo site_url('VipController/upari') ?>" method="post">
...
function myFunctionPitanja() {
    ...
    window.location.replace("<?php echo site_url('VipController/odgovoriNaPitanja') ?>");
