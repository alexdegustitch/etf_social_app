<html>
    ...
    <body>
        ...
        <div class="container" style="background-image: url('http://localhost/social/images/50.jpg');">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <form name="brisanje" action="<?php echo site_url('AdminController/obrisiKorisnike/') ?>" method = 'get'>
                        <center>
                            <h3 style="padding: 15px;"> <i> Zahtevi za brisanje profila: </i> </h3>
                            <div class="par" style="border: 1px dotted; ">
                                <?php
                                foreach ($korisnici as $korisnik) {
                                    echo "<div class='row'> <div class='col-sm-12'> ";
                                    echo "<input type='checkbox' name = '".$korisnik->Username."' value = '".$korisnik->Username."' >";
                                    echo "<a href='" . site_url('AdminController/posetiProfil/') . $korisnik->Username . "'> @" . $korisnik->Username . " </a> ";
                                   
                                    echo "</div> </div>";
                                }
                                
                                ?>
                                <input type='submit' name='user' value='Obrisi' class='btn btn-dark' style='aling-text:center;'>
                            </div>
                        </center>
                    </form>
                </div>
