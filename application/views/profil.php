<html>
    ...
    if ($pitanja == false) {
        echo 'myFunctionPitanja()';
    } else {
        if (isset($zahtev)) {
            if ($zahtev == 2) {
                echo 'alert("Zahtev je prihvacen.")';
            } else if ($zahtev == 1) {
                echo 'alert("Vec ste poslali zahtev za brisanje!")';
            } else if ($zahtev == 3) {
                echo 'myFunction()';
            }
        }
                    ...
                    <ul class='nav navbar-nav'>
                        <li class='nav-item dropdown'>
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="<?php echo site_url('KorisnikController/izmeniProfil') ?>"> Izmeni profil </a>         
                                <a class="dropdown-item" href="<?php echo site_url('KorisnikController/izmeniOdgovore') ?>"> Izmeni odgovore </a>
                                <a class="dropdown-item" href="<?php echo site_url('KorisnikController/postaniVIP') ?>"> Postani VIP </a>
                                <a class="dropdown-item" href="<?php echo site_url('KorisnikController/obrisi') ?>"> Obrisi </a>
                                <a class="dropdown-item" href="<?php echo site_url('KorisnikController/izlogujSe') ?>"> Izloguj se </a>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <div class="container" style="background-image: url('http://localhost/social/images/50.jpg');">
            ...
            <div class = "row">
                <div class = "col-sm-12 col-md-4 col-lg-4">
                    ...
                    <p class = "par" style = "border: 1px dotted; ">
                        ...
                        foreach ($zapraceni as $zapracen) {
                            echo "<a href='" . site_url('KorisnikController/posetiProfil/') . $zapracen . "'> @" . $zapracen . " </a> <br/>";
                        }
                        ?>
                    </p>
                </div>
                <div class="col-sm-12 col-md-4 col-lg-4">
                    ...
                    <form name="formaSlika" action="<?php echo site_url('KorisnikController/promeniSliku') ?>" method="get">
                        <center>
                ...
                <div class="col-sm-12 col-md-4 col-lg-4" style="padding: 20px; padding-top: 100px; ">
                    <form name="podaci" action="<?php echo site_url('KorisnikController/upari') ?>" method="post">
                        <table class="table table-dark table-striped" >
                            <tr id="prvired">
                                <td> E-MAIL: </td>
                                <td id="prvakol">
                                    <input type="label" value="<?php echo $email; ?>" size="30" disabled="disabled">
                                </td>
                            </tr>
                            <tr id="drugiired">
                                <td> POL: </td>
...
function myFunction() {
    ...
    var txt;
    var r = confirm("Istekla Vam je pretplata! Zelite li da nastavite sa pretplatom?");
    if (r == true) {

        window.open("<?php echo site_url('KorisnikController/postaniVIP') ?>");
    }

}

function myFunctionPitanja() {
    alert("Dodata su neka nova pitanja. Kliknite na 'OK' kako biste odgovorili na njih.");
    window.location.replace("<?php echo site_url('KorisnikController/odgovoriNaPitanja') ?>");
