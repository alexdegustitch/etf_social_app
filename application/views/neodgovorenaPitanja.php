<html>
    ...
    <body>
                    ...
                    <ul class='nav navbar-nav'>
                        <li class='nav-item'><a class="nav-link loadContent" href="<?php
                            if ($tip == 'a') {
                                ...
                                echo site_url('VipController/index');
                            }
        ...
        <div class="container" style="background-image: url('http://localhost/social/images/50.jpg');">
            <form name="izmenaOdg" action = '<?php
            if ($tip == 'a') {
                echo site_url('AdminController/potvrdiOdgNaNeodgovorena');
            } else if ($tip == 'k') {
                echo site_url('KorisnikController/potvrdiOdgNaNeodgovorena');
            } else {
                echo site_url('VipController/potvrdiOdgNaNeodgovorena');
            }
            ?>' method='post'>
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <input type='submit' name='registracija' value='Sačuvaj odgovore' class="btn btn-lg btn-dark">
                        <a href='<?php
                        if ($tip == 'a') {
                            echo site_url('AdminController/index');
                        } else if ($tip == 'k') {
                        ...
                        ?>'> <input type='button' name='registracija' value='Vrati se nazad'  class="btn btn-lg btn-dark"> </a>
                    </div>
                </div>
            </form>
        </div>
