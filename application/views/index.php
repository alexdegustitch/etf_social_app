            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark justify-content-center">
                ...
                <div class="collapse navbar-collapse" id="myMenu">
                    <ul class='nav navbar-nav'>
                        <li class='nav-item active'><a class="nav-link loadContent" href="#"  title='Info'> Info </a></li>
                        ...
                        <li class='nav-item'><a class="nav-link loadContent" href="<?php echo site_url('GostController/prijava') ?>" title='Prijava'> Prijava </a></li>
                        <li class='nav-item'><a class="nav-link loadContent" href="<?php echo site_url('GostController/registracija') ?>" title='Registracija'>Registracija </a></li>
                    </ul>
                </div>
            </nav>
        </div>
        ...
        <div class="container" style="background-image: url('http://localhost/social/images/50.jpg');">
            ...
            <div class="row">
                <div class="col-sm-12" style="padding-top: 100px;">
                    <p class="par">
                        Ova aplikacija predstavlja pre svega vid zabave za studente Elektrotehničkog fakulteta. <br>
                        Korisnicima je omogućeno da se registruju, a potom da nađu osobe koje su njima slične za druženje, zabavu,
                        ali i da pronađu kolege za rad na fakultetskim projektima i ostalim obavezama sa kojima se susreću tokom studiranja.
                    </p>
                </div>
            </div>
