    ...
    <body>
        ...
        <div class="container" style="background-image: url('http://localhost/social/images/50.jpg');
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-6" style="padding: 50px;
                    ...
                    ?>" alt="nema slike" width="160px" height="160px" style="align:center;" class="img-fluid mx-auto d-block ">
                    ...
                    <table class="table table-dark table-striped" >
                        ...
                        <tr id="trecired">
                            ...
                            <td id="trecakol">
                                ...
                                if ($zapracen) {
                                    echo site_url('VipController/otprati/') . $username;
                                } else {
                                    echo site_url('VipController/zaprati/') . $username;
                                }
                                ?>" method ="post">
                        ...
                        <tr id="cetvrtired">
                            ...
                            <td id="cetvrtakol">
                                 ...
                                 <form name='forma' id='forma' action='<?php echo site_url('VipController/potvrdiSlanje/') . $username;?>' method="post">
        ...
        <script>
            function posaljiPoruku() {
                ...
                koje mozete poslati u toku dana je 15.");
                    if (poruka == true) {
