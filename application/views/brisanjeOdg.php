<html>
    ...
    <body>
        ...
        <div class="container" style="background-image: url('http://localhost/social/images/50.jpg');">
            <form name="izmenaOdg" action='<?php echo site_url('AdminController/potvrdiBrisanjePitanja'); ?>' method="get">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        ...
                        <input type='submit' name='obrisi' value='Obrisi pitanje' class="btn btn-lg btn-dark">
