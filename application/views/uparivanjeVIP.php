    ...
    <body>
        ...
        <div class="container" style="background-image: url('http://localhost/social/images/50.jpg');">
            <div class="pom">
                ...
                <form name="forma" action="<?php echo site_url('VipController/upariMe') ?>" method="post">
                    <div class="row" style="height: 10%">
                        ...
                        <div class="col-sm-12 col-md-3 col-lg-3">
                            <center>
                                <a href="<?php echo site_url('VipController/upariPoPitanju') ?>"> <input type='button' name='registracija' value='Za konkretno pitanje' class="btn btn-dark btn-lg"> </a>
                            </center>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-12" align="center">
                        ...
                        if (isset($korisnici)) {
                            foreach ($korisnici as $korisnik) {
                                echo $i . ". <a href='" . site_url('VipController/posetiProfil/') . $korisnik->user . "'> @" . $korisnik->user . " </a> " . $korisnik->procenat . " % <br/> <br/>";
                                $i++;
                                if($i >= 15){
                                    break;
                                }
